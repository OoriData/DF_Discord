...
- Next, you'll need to buy a vehicle. 🚗
  - Use the `grey button with a city name` to investigate the vendors in the city you spawned in, and head to the ~~dealership~~ stealership to get yourself some wheels.
...
- After that, you're gonna need to buy some *Fuel* from the gas station, which you can also access from the `city name button`. ⛽️
  ...
  - Next, grab some water from the market, (imaginatively named) `Water Jerry Cans`, and finally you'll wanna buy some `MRE boxes` to feed your crew, also at the market.
